...
public class Shooter extends ChargerSubsystem {
    private final Tunable<Double>
        flywheelKp = Tunable.of(key("Flywheel/KP"), 5.0),
        flywheelKd = Tunable.of(key("Flywheel/KD"), 0.0),
        flywheelKv = Tunable.of(key("Flywheel/KV"), 0.0);
    ...
    private final PivotHardware hoodIO = switch (RobotMode.get()) {
        ...
        case SIM -> new SimPivotHardware(ShooterConsts.HOOD_SIM_CFG);
