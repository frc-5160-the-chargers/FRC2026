...
public class TunerConstants {
    ...
    private static final Angle kFrontLeftEncoderOffset = Radians.of(2.602).plus(Degrees.of(90));
    ...
    private static final Angle kBackLeftEncoderOffset = Radians.of(-3.758).plus(Degrees.of(180));
