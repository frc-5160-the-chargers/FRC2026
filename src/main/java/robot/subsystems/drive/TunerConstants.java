...
public class TunerConstants {
    ...
    private static final Angle kBackLeftEncoderOffset = Radians.of(-3.758);
    ...
    private static final Angle kBackRightEncoderOffset = Radians.of(0.954).minus(Degrees.of(225));
