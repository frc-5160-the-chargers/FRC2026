...
public class TunerConstants {
    ...
    private static final Angle kFrontLeftEncoderOffset = Radians.of(2.602);
    ...
    private static final Angle kFrontRightEncoderOffset = Radians.of(2.361).plus(Degrees.of(180));
