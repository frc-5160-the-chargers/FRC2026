...
public class FieldConstants {
    ...
    public static class LinesVertical {
        public static final double center = FIELD_LAYOUT.getFieldLength() / 2.0;
    ...
    public static class LinesHorizontal {
        ...
        public static final double center = FIELD_LAYOUT.getFieldWidth() / 2.0;
        ...
        public static final double leftTrenchOpenStart = FIELD_LAYOUT.getFieldWidth();
    }
    ...
    public static class Hub {
        ...
        public static final Translation3d topCenterPoint =
            new Translation3d(
                ...
                FIELD_LAYOUT.getFieldWidth() / 2.0,
                height);
        ...
        public static final Translation2d nearLeftCorner =
            new Translation2d(topCenterPoint.getX() - width / 2.0, FIELD_LAYOUT.getFieldWidth() / 2.0 + width / 2.0);
        ...
        public static final Translation2d oppNearLeftCorner =
            new Translation2d(oppTopCenterPoint.getX() - width / 2.0, FIELD_LAYOUT.getFieldWidth() / 2.0 + width / 2.0);
    ...
    public static class LeftTrench {
        ...
        public static final Translation3d openingTopLeft =
            new Translation3d(LinesVertical.hubCenter, FIELD_LAYOUT.getFieldWidth(), openingHeight);
        public static final Translation3d openingTopRight =
            new Translation3d(LinesVertical.hubCenter, FIELD_LAYOUT.getFieldWidth() - openingWidth, openingHeight);

        // Relevant reference points on opposing side
        public static final Translation3d oppOpeningTopLeft =
            new Translation3d(LinesVertical.oppHubCenter, FIELD_LAYOUT.getFieldWidth(), openingHeight);
        public static final Translation3d oppOpeningTopRight =
            new Translation3d(LinesVertical.oppHubCenter, FIELD_LAYOUT.getFieldWidth() - openingWidth, openingHeight);
    }
    ...
    public static class Tower {
        ...
        public static final Translation2d oppCenterPoint =
            new Translation2d(
                FIELD_LAYOUT.getFieldLength() - frontFaceX,
    ...
    public static class Depot {
        ...
        public static final Translation3d depotCenter =
            new Translation3d(depth, (FIELD_LAYOUT.getFieldWidth() / 2) + distanceFromCenterY, height);
        public static final Translation3d leftCorner =
            new Translation3d(depth, (FIELD_LAYOUT.getFieldWidth() / 2) + distanceFromCenterY + (width / 2), height);
